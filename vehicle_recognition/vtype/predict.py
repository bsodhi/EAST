...
model1 = load_model(os.path.dirname(os.path.abspath(__file__)) + "\\models\\mobilenet_v2.h5")
model2 = load_model(os.path.dirname(os.path.abspath(__file__)) + "\\models\\inception_v3.h5")
model3 = load_model(os.path.dirname(os.path.abspath(__file__)) + "\\models\\densenet.h5")
